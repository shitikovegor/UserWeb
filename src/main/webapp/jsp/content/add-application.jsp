        ...
        <div class="container">
            ...
            <form action="controller" method="post">
                ...
                <div class="form-group">
                    ...
                    <div>
                        <input type="radio" id="cargo" name="application_type" value="cargo" required=""
                               ${cargoSelect ? 'checked' : ''} onclick="toggleSet()">
                        <p class="d-inline" style="margin-right: 30px;margin-top: 0px;margin-left: 5px;"><fmt:message
                                key="application.cargo"/></p>
                        <input type="radio" id="passenger" name="application_type" value="passenger" required=""
                               ${passengerSelect ? 'checked' : ''} onclick="toggleSet()">
                        <p class="d-inline" style="margin-right: 30px;margin-top: 0px;margin-left: 5px;"><fmt:message
                ...
                <div class="form-group">
                    <label for="departure_date"><fmt:message key="application.dateTime"/></label>
                    <input class="form-control item" id="departure_date" name="departure_date"
                           required="" value="${departure_date}"
                           type="datetime-local"
                ...
                <div class="form-group">
                    <label for="arrival_date"><fmt:message key="application.dateTime"/></label>
                    <input class="form-control item" id="arrival_date" name="arrival_date"
                           required="" value="${arrival_date}" type="datetime-local" onfocus="dateValidation()">
                </div>
                <div class="form-group">
                ...
                <button class="btn btn-primary btn-block"
                        type="submit"><fmt:message key="page.addApplication.title"/></button>
                <c:if test="${adding_error}">
                    <p class="text-center text-danger"><fmt:message key="error.addApplication"/></p>
                </c:if>
            </form>
        </div>
    </section>
